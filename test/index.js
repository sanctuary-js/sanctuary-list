...
testLaws ('Monoid') (laws.Monoid (Z.equals, List)) ({
  leftIdentity: [
    ListArb (jsc.string),
  ],
  rightIdentity: [
...
testLaws ('Applicative') (laws.Applicative (Z.equals, List)) ({
  identity: [
    ListArb (jsc.number),
  ],
  homomorphism: [
...
// testLaws ('ChainRec') (laws.ChainRec (Z.equals, List)) ({
//   equivalence: [
...
// testLaws ('Monad') (laws.Monad (Z.equals, List)) ({
//   leftIdentity: [
//     jsc.constant (head),
...
testLaws ('Plus') (laws.Plus (Z.equals, List)) ({
  leftIdentity: [
    ListArb (jsc.number),
  ],
  rightIdentity: [
...
testLaws ('Alternative') (laws.Alternative (Z.equals, List)) ({
  distributivity: [
    ListArb (jsc.number),
    ListArb (jsc.constant (Math.sqrt)),
    ListArb (jsc.constant (Math.abs)),
